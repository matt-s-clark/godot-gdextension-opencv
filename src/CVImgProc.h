...
public:
	...
	static Ref<CVRect> bounding_rect(Variant array);
	...
	static Ref<CVMat> convex_hull(Variant points, Dictionary additional_parameters);
	static Ref<CVMat> convexity_defects(Variant contour, Ref<CVMat> convexhull);
	static Dictionary find_contours(Ref<CVMat> image, int mode, int method, Dictionary additional_parameters);
	static Ref<CVMat> fit_line(Variant points, int distType, float param, float reps, float aeps);
	static Dictionary intersect_convex_convex(Ref<CVMat> p1, Ref<CVMat> p2, Dictionary additional_parameters);
	static bool is_contour_convex(Variant contour);
