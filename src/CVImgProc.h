...
public:
	...
	static void ellipse(Ref<CVMat> img, Vector2 center, Vector2 axes, float angle, float startAngle, float endAngle, Dictionary additional_parameters);
	...
	static void line(Ref<CVMat> img, Vector2 pt1, Vector2 pt2, Dictionary additional_parameters);
