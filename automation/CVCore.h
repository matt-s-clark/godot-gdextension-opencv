...
public:
	...
	bool checkRange(Ref<CVMat> a, Dictionary additional_parameters);
	...
	Ref<CVMat> copyMakeBorder(Ref<CVMat> src, int top, int bottom, int left, int right, int borderType, Dictionary additional_parameters);
	...
	Ref<CVMat> flipND(Ref<CVMat> src, int axis);
	...
	void minMaxIdx(Ref<CVMat> src, float *minVal, Dictionary additional_parameters);
	void minMaxLoc(Ref<CVMat> src, float *minVal, Dictionary additional_parameters);
	void mixChannels(Ref<CVMat> *src, int nsrcs, Ref<CVMat> *dst, int ndsts, int *fromTo, int npairs);
	...
	void randShuffle(Ref<CVMat> dst, Dictionary additional_parameters);
	...
	Ref<CVMat> reduceArgMax(Ref<CVMat> src, int axis, Dictionary additional_parameters);
	Ref<CVMat> reduceArgMin(Ref<CVMat> src, int axis, Dictionary additional_parameters);
	...
	Ref<CVMat> transposeND(Ref<CVMat> src, Dictionary additional_parameters);
